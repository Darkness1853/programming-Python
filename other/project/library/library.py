...
import winsound
winsound.PlaySound("835d7c89356a150.wav",winsound.SND_FILENAME | winsound.SND_ASYNC)
def load_books():
    global lines
...
def save_books():
    with open('library2.txt', 'w', encoding='utf-8') as file:
        newline = []
        for line in lines:
            newline.append(line + '\n')
...
def search():
    ...
    found = False
    for line in lines:
        title, writer, cnt = line.strip().split(';')
...
root.iconbitmap("C:/Users/~Darr_Kness~/Downloads/images-_3_.ico")
canvas = tk.Canvas(root, width=800, height=600, bg='lightblue')
canvas.pack()

image1 = Image.open("C:/Users/~Darr_Kness~/Downloads/Samizdat.jpg")
